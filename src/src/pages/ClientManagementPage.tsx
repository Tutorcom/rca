...
import { FaUsers, FaEnvelope, FaCheckCircle, FaChevronDown } from 'react-icons/fa';
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg py-1 z-10 border border-slate-200">
                   {user.status === 'pending_review' && (
                        ...
                        >
                            <FaCheckCircle className="w-4 h-4 text-success"/> Approve
                        </button>
                   )}
                   <button 
                        ...
                        className="w-full text-left flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100"
                    >
                        <FaEnvelope className="w-4 h-4 text-primary"/> Send Message
                    </button>
                </div>
            )}
        </div>
