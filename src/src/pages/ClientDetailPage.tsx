...
import { FaArrowLeft, FaCheckCircle, FaFileContract, FaEnvelope } from 'react-icons/fa';
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                    <div className="flex items-center gap-4">
                     ...
                     <div className="mt-4 border-t pt-4 space-y-3">
                        <InfoPill label="Contact Email" value={client.email} icon={<FaEnvelope className="w-5 h-5" />} />
                        <InfoPill label="Total Projects" value={projects.length.toString()} icon={<FaFileContract className="w-5 h-5" />} />
                        <InfoPill label="Open Tasks" value={tasks.filter(t=>t.status !== 'done').length.toString()} icon={<FaCheckCircle className="w-5 h-5" />} />
                    </div>
                </div>
            </div>
