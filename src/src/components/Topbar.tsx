...
import { FaSearch, FaBell, FaChevronDown, FaSignOutAlt, FaGlobe } from 'react-icons/fa';
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="relative">
            ...
            >
                ...
                <FaChevronDown className={`h-5 w-5 text-slate-500 transition-transform group-hover:text-slate-800 ${isDropdownOpen ? 'rotate-180' : ''}`} />
            </button>
            {isDropdownOpen && (
                <div 
                ...
                >
                    ...
                    >
                        <FaSignOutAlt className="w-5 h-5 text-slate-500" />
                        Logout
                    </button>
                </div>
            )}
